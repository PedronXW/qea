...
describe('Authentication', () => {
  ...
  it('should not be able to authenticate a client because a wrong email', async () => {
    await request(app).post('/clients').send({
      name: 'John Doe',
      email: 'johndoe@johndoe.com',
      password: '12345678',
  ...
  it('should not be able to authenticate a client because a wrong password', async () => {
    await request(app).post('/clients').send({
      name: 'John Doe',
      email: 'johndoe@johndoe.com',
      password: '12345678',
